...
class Cord {
public:
    Cord() : head_(inlineBlock_), tail_(head_) {}
    ...
    Cord<kBlockSize>& write(const char* value, size_t len) {
        if (len == 0) {
            return *this;
        }
